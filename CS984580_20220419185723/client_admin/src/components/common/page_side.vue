<template>
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			,'/physical_examination_personnel/table'
			])">
			...
			<el-menu-item index="/physical_examination_personnel/table" v-show="user_group == '管理员' || $check_action('/physical_examination_personnel/table')"><span>体检人员</span></el-menu-item>
			...
			auth() {
				...
				for (var i = 0; i < tables.length; i++) {
					...
					if (o.path.indexOf("/table") !== -1) {
						...
						list.push("physical_examination_personnel");
