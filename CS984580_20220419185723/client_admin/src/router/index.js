...
const routes = [
	...
	// 体检人员路由
	{
		path: '/physical_examination_personnel/table',
		name: 'physical_examination_personnel_table',
		component: () => import('../views/physical_examination_personnel/table.vue')
	},
	{
		path: '/physical_examination_personnel/view',
		name: 'physical_examination_personnel_view',
		component: () => import('../views/physical_examination_personnel/view.vue')
	},
	// 体检套餐路由
	{
	...
	// 体检计划路由
	{
		path: '/physical_examination_plan/table',
		name: 'physical_examination_plan_table',
		component: () => import('../views/physical_examination_plan/table.vue')
	},
	{
		path: '/physical_examination_plan/view',
		name: 'physical_examination_plan_view',
		component: () => import('../views/physical_examination_plan/view.vue')
	},
	// 健康档案路由
	{
...
router.afterEach((to, from, next) => {
	let title = "北华大学附属医院体检中心管理系统-admin";
