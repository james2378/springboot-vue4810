				...
				<div class="row">
						...
						<!-- 图片 -->
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/physical_examination_plan/edit','add')" @click="to_form('/physical_examination_plan/edit')" >预约体检 </button>
							</div>
						<!-- 富文本 -->
