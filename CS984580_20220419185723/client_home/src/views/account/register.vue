						...
						<div class="card">
							...
							<div class="form_register">
								<b-form>
									...
									<!--体检人员-->
									<form_physical_examination_personnel v-if="form.user_group === '体检人员'" :form="form_sub"></form_physical_examination_personnel>
...
<script>
	...
	/* 体检人员 */
	import form_physical_examination_personnel from "@/components/diy/form_physical_examination_personnel";

	export default {
		components: {
			/* 体检人员 */
			form_physical_examination_personnel,
		},
